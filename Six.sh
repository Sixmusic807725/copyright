...
echo $green  "|+CODING : MR.Six         |"
echo $yellow "|+CONTAC : 081227443846.       |"
echo $yellow "|+THANKS TO : [•]RevoersTeam[•]       |"
echo $yellow "|+Instagram : maxusgaming   |"
echo $yellow "|+Ngrecode Besok kesialan datang aminn |"
echo $yellow "|~Special Thanks to Allah SWT  |"
echo $yellow "+==========[RevoersTeam]===========+"
echo $blue ">>=========={MENU}==========<<"
echo ""
echo ""
...
echo $b "Selamat anda Menggunakan Tools Ini!! :)"
